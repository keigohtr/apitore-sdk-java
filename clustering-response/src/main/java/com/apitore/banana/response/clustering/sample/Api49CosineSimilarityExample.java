 ...
 */
public class Api49CosineSimilarityExample {

  static String ENDPOINT     = "https://api.apitore.com/api/49/cosine-similarity/vec-vec";
  ...
  public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
    ...
    req.setVec1(new double[]{1,0,1});
    req.setVec2(new double[]{1,1,1});
